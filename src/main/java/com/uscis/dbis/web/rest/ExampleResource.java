...
import com.uscis.dbis.service.ExampleService;
import com.uscis.dbis.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.uscis.dbis.domain.Example}.
 */
@RestController
...
public class ExampleResource {
    ...
    public ResponseEntity<Example> createExample(@Valid @RequestBody Example example) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/examples/" + example.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, example.getId()))
            .body(example);
    }
    ...
    public ResponseEntity<Example> updateExample(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, example.getId()))
            .body(example);
    }
    ...
    public ResponseEntity<Example> partialUpdateExample(
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, example.getId()));
    }
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<Example>> getAllExamples(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<Example> getExample(@PathVariable("id") String id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteExample(@PathVariable("id") String id) {
