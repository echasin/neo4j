...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './example.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXAMPLE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EXAMPLE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EXAMPLE actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_EXAMPLE actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_EXAMPLE actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_EXAMPLE actions', async () => {
      const arg = 42666;
